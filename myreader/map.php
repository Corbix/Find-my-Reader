            ...
            function initMap() {
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function (position) {
                        ...
                        var newurl = "http://findmyreader.000webhostapp.com/map.php?lat=" + pos.lat + "&long=" + pos.lng;
                ...
                downloadUrl('http://findmyreader.000webhostapp.com/getMarkers.php', function (data) {
                    ...
                    Array.prototype.forEach.call(markers, function (markerElem) {
                        ...
                        button.setAttribute('onclick', `window.location.href='http://findmyreader.000webhostapp.com/profile.php?email=${email}'`)
